...
local function define_tests()
    ...
    describe("Agent Node Truncation with Real LLM", function()
        it("should detect truncation from real Claude response and recover", function()
            ...
            local workflow_commands = {
                {
                    ...
                    payload = {
                        ...
                        config = {
                            agent = "userspace.dataflow.node.agent.stub:real_truncation_test_agent",
                            show_tool_calls = false,
                            arena = {
                                prompt = "Analyze this dataset and call the noop_tool with a full detailed report.",
                                max_iterations = 5,
                                tool_calling = "auto",
                            },
                            data_targets = {
                        ...
                        metadata = {
                            title = "Real LLM Truncation Test"
                        }
                    }
                },
                {
                    ...
                    payload = {
                        ...
                        content = { task = "analyze sales data for Q1 2025" },
            ...
            local dataflow_id, create_err = c:create_workflow(workflow_commands, {
                metadata = { title = "Real LLM Truncation Test Workflow" }
            })
